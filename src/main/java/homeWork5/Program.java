...
public class Program {
    ...
    /**
     * Метод записывает в файл случайную последовательность символов.
    ...
    /**
     * Метод записывает в файл случайную последовательность символов, а также указанное слово.
     * @param fileName   имя файла.
     * @param length     длина последовательности символов.
    ...
    /**
     * Метод для поиска указанного слова в файле.
     * @param fileName   имя файла.
    ...
    /**
     * Метод для поиска указанного слова в файле с заданным смещением.
     * @param fileName   имя файла.
    ...
    /**
     * Метод для поиска указанного слова в файлах внутри директории и её поддиректорий.
